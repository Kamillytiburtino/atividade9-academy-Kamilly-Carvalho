describe("Verifica fluxo App/Alert Dialogs/OK CANCEL DIALOG WITH MESSAGE;", () => {
    ...
    xit("deve existir botão app", async () => {
    ...
    xit("deve ir para a tela App ao clicar no botão", async () => {
    ...
    xit("deve exibir Alert ao clicar no botão CANCEL DIALOG WITH MESSAGE ", async () => {
...
describe("Verifica fluxo App/Alert Dialogs/LIST DIALOG", () => {
    ...
    xit("deve exibir Alert ao clicar no botão LIST DIALOG ", async () => {
